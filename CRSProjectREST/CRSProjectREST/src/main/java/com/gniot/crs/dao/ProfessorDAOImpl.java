...
public class ProfessorDAOImpl implements ProfessorDAOInterface {
	...
	public void addGrade(int studentId, int courseId, String grade, int professorId, int gradeId) {
	    ...
	    try (Connection conn = DBUtils.getConnection()) {
	        System.out.println("Checking if course is taught by professor");
	        ...
	        try (PreparedStatement checkStmt = conn.prepareStatement(SQLConstant.FETCH_ADD_GRADE)) {
	            ...
	            try (ResultSet rs = checkStmt.executeQuery()) {
	                if (rs.next()) {
	                    System.out.println("Existing grade record found, updating grade");
	        ...
	        System.out.println(RED + "SQLException: " + ex.getMessage() + RESET);
